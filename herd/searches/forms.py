...
class QueryForm(FlaskForm):
    query_history = SelectField('Query History', choices=['None'])
    chromosome = SelectField('Chromosome', choices=['None','chr1', 'chr2', 'chr3', 'chr4', 'chr5', 'chr6', 'chr7', 'chr8', 'chr9', 'chr10',
                             'chr11', 'chr12', 'chr13', 'chr14', 'chr15', 'chr16', 'chr17', 'chr18', 'chr19', 'chr20', 'chr21', 'chr22', 'chrX', 'chrY'],
                              validators=[AnyOf(['chr1', 'chr2', 'chr3', 'chr4', 'chr5', 'chr6', 'chr7', 'chr8', 'chr9', 'chr10',
                             'chr11', 'chr12', 'chr13', 'chr14', 'chr15', 'chr16', 'chr17', 'chr18', 'chr19', 'chr20', 'chr21', 'chr22', 'chrX', 'chrY'],
                             'Please select a chromosome value')])
    ...
    system = SelectField('System',choices=['All','Embryo','Musculoskeletal','Integumentary','Endocrine','Lymphatic','Urinary','Reproductive','Circulatory','Nervous','Digestive','Respiratory'])
    organ = SelectField('Organ', choices=['All'])
    tissue = SelectField('Tissue',choices=['All'])
